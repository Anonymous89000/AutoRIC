...
from pysyrenn.frontend import ReluLayer
...
def get_constraint(params_index:List[int], indice:List[int], netname:Literal):
    """ 线性化得到约束 
    """
    ...
    network = CensusNet(14)
    network.load_state_dict(torch.load('data/census.pt'))
    layers = []
...
if __name__=='__main__':
    get_constraint(params_index_c,[1,2],'testnet1')
