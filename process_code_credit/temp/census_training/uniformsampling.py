# Census-income数据集进行均匀采样，固定gender(sex)，均匀生成其他特性的数据
import random
import pandas as pd
import numpy as np
...
headers = ['age', 'workclass', 'fnlwgt',
           'education', 'education_num',  'marital-status', 'occupation',
...
def gen_male():
      ...
      #                 'Black', gender, capital_gain, capital_loss, hr_per_week, native_country]
          gen_male = [age, work_class, fnlwgt, education,education_num, marital_status, occupation, relationship,
      ...
      df_male.to_csv('sample_data/gen_male.csv')
...
def gen_female():
      ...
      #     gen_r4 = [age, work_class, fnlwgt, education,education_num, marital_status, occupation, relationship,
      #                 'Black', gender, capital_gain, capital_loss, hr_per_week, native_country]
          gen_female = [age, work_class, fnlwgt, education,education_num, marital_status, occupation, relationship,
      ...
      # df_female.to_csv('gender_fairness/sample_sex/gen_female.csv')
      df_female.to_csv('sample_data/gen_female.csv')
